/*
 * @(#) GmlToRdf.java	version 1.2   23/3/2017
 *
...
/**
 * Entry point to convert GML files into RDF triples.
...
{
	/**
     * Accept two arguments: the name of an GML file, and the name of the resulting RDF file.
     * EXAMPLE: java -cp lib/*;TripleGeo.jar eu.slipo.athenarc.triplegeo.GmlToRdf ./data/samples.gml ./data/test1.rdf
     */
    public static void main(String[] args) throws IOException, SAXException 
    {
        ...
        if (args.length != 2) {
            ...
            System.err.println("  java " + GmlToRdf.class.getName(  )
                    + " <fileGML> <fileRDF>");
            System.exit(1);
        }
        ...
        String fileXSLT = "./xslt/GML2RDF.xsl";   //Predefined XSLT stylesheet to be applied in transformation
