/*
 * @(#) SpatiaLiteDbConnector.java 	 version 1.3   3/11/2017
 *
...
/**
 * SpatiaLite implementation of DbConnector class.
...
public class SpatiaLiteDbConnector implements DbConnector {
   ...
   */
  public SpatiaLiteDbConnector(String dbName) {
    super();
    this.dbName = dbName;
  ...
  private Connection openConnection() {
    ...
    try {
      Class.forName(Constants.DRIVERS[Constants.SPATIALITE]);
      ...
      String sql = "SELECT sqlite_version(), spatialite_version()";
    	...
    	ExceptionHandler.invoke(ex, "Cannot connect to the database. SpatiaLite module is missing! Native libraries for SpatiaLite (https://www.gaia-gis.it/fossil/libspatialite/index) must be located in the directory at which the Java application is called in order to run smoothly this class.");
    }
